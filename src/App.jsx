...
// Başlık map’i (gerekirse genişlet)
...
/* Tip (Konut/Ticari) kuralı: B 37–43, C 1–10, '-' 33–39 -> Ticari */
...
export default function App() {
  ...
  const handleSave = async () => {
    ...
    // her iki modda da durum + updatedAt
  ...
  const report = useMemo(() => {
    ...
    // kırılım: Tip → ProjeRoot → (24 Gayrimenkul / Diğerleri) + Toplam
